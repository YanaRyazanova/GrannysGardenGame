    ...
    public partial class LoseForm : Form
    {
        ...
        public void InitializeComponent()
        {
            ...
            textBox = new PictureBox
            {
                Width = 312,
                Height = 312,
                Image = new Bitmap(@"C:\Users\mbara\OneDrive\Documents\ЯТП\Granny's Garden Game\GrannysGardenGame\Images\Ur Killed.png"),
            ...
            newGameButton = new Button
            {
                Width = 199,
                Height = 65,
                Image = new Bitmap(@"C:\Users\mbara\OneDrive\Documents\ЯТП\Granny's Garden Game\GrannysGardenGame\Images\PlayAgain.png"),
                Dock = DockStyle.None
            };
